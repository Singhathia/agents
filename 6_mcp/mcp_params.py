...
tavily_env = {
    ...
    "DEFAULT_PARAMETERS": '{"search_depth": "basic", "max_results": 5, "include_raw_content": false}',
}
...
# The full set of MCP servers for the trader:
# Accounts, Push Notification and the Market
...
# The full set of MCP servers for the researcher:
# Fetch, Tavily Search and Memory
